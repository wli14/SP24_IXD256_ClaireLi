...
#### Use the map_value function to map the light sensor input value range(0 to 4095) to output value range(60 to 170). Constantly compare the current servo_val with the servo_val_final to loop the servo to new position represented by servo_val.
